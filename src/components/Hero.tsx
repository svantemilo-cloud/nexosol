...
export function Hero() {
  return (
    <section className="relative min-h-[100dvh] min-h-screen pt-[calc(4.75rem+env(safe-area-inset-top,0px))] pb-12 sm:pb-16 md:min-h-screen md:pt-28 md:pb-24 overflow-hidden -mt-16">
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6">
        <div className="grid md:grid-cols-2 gap-8 md:gap-10 lg:gap-14 items-center">
          ...
          <div className="order-2 md:order-1 bg-surface md:bg-transparent rounded-2xl md:rounded-none md:pr-4 px-1 sm:px-0 py-1 -mx-0.5 sm:mx-0">
            ...
            <h1 className="text-[1.65rem] leading-snug sm:text-3xl md:text-4xl lg:text-5xl font-bold text-forest mb-4">
              Enklare energi,{" "}
          ...
          <div className="order-1 md:order-2 relative min-h-[280px] sm:min-h-[320px] md:min-h-[380px] flex items-center justify-center pt-6 sm:pt-12 md:pt-24">
            <div className="relative w-full mx-0 sm:mx-2 md:mx-0 my-2 sm:my-4 max-w-md rounded-2xl sm:rounded-2xl shadow-soft-lg border border-forest/10 bg-white">
              <div className="p-5 sm:p-8">
                ...
                <div className="space-y-3">
                  {productOptions.map((opt, i) => (
                    <a
                      key={i}
                      href={opt.href}
                      className="group flex items-center gap-4 min-h-[52px] p-4 rounded-xl bg-surface border border-forest/10 hover:border-forest/20 hover:shadow-soft active:bg-forest/[0.04] transition-all"
                    >
                ...
                <a
                  href="#calculator"
                  className="mt-6 flex items-center justify-center gap-2 w-full rounded-2xl bg-forest text-white font-semibold py-4 min-h-[52px] shadow-soft hover:shadow-soft-lg active:scale-[0.99] transition-all hover:bg-forest-light"
                >
                  Jämför offerter nu
